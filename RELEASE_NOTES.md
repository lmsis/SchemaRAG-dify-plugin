...
| Item | Valor |
|------|--------|
| **Versão atual no repo** | `0.2.3` — plugin id **`lmsis/lm_db_schema_rag`** |
| **Próxima versão sugerida** | `0.2.4` ou `0.3.0` — conforme alterações |
...
4. **`UPDATE.md`** — histórico de versões (inclui `0.2.3`, `0.2.2`, … e notas de breaking).
...
`v0.2.3 — LM DB Schema RAG: CI só .difypkg; PR dify-plugins desativado`

### Tag Git (exemplo)

`v0.2.3` ou `0.2.3` — *usar a mesma convenção dos releases anteriores do repositório.*
...
- [ ] Ajustado o número da versão no **título** do GitHub Release se não for `v0.2.3`.
