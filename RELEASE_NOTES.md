...
| Item | Valor |
|------|--------|
| **Versão atual no repo** | `0.2.1` — plugin id **`lmsis/lm_db_schema_rag`** |
| **Próxima versão sugerida** | `0.2.2` ou `0.3.0` — conforme alterações |
...
4. **`UPDATE.md`** — histórico de versões (inclui `0.2.1`, `0.2.0` e notas de breaking).
...
`v0.2.1 — LM DB Schema RAG: README acknowledgments (upstream SchemaRAG)`

### Tag Git (exemplo)

`v0.2.1` ou `0.2.1` — *usar a mesma convenção dos releases anteriores do repositório.*
...
- [ ] Ajustado o número da versão no **título** do GitHub Release se não for `v0.2.1`.
